...
function State({ loading, data, reload }: Props) {
  if (loading) return <div className="sun-card p-6 text-sm text-[#512314]/65">Carregando dados reais deste workspace…</div>
...
export function LiveInvites(props: Props) {
  ...
  if (!items.length) return <Empty>Ainda não há convites reais de cadastro criados para este workspace.</Empty>
